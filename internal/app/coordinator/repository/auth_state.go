...
// AuthStateRepository is a database implementation of AuthStateRepository.
type AuthStateRepository struct {
	queries  *sqlc.Queries
	stateTTL time.Duration
}

// NewAuthStateRepository creates a new database-backed auth state repository.
func NewAuthStateRepository(queries *sqlc.Queries, ttl time.Duration) *AuthStateRepository {
...
func (s *AuthStateRepository) Create(ctx context.Context, state *oidc.AuthState) error {
...
func (s *AuthStateRepository) Get(ctx context.Context, state string) (*oidc.AuthState, error) {
...
func (s *AuthStateRepository) Delete(ctx context.Context, state string) error {
	return s.queries.DeleteAuthState(ctx, state)
}

// DeleteExpired deletes all expired auth states.
func (s *AuthStateRepository) DeleteExpired(ctx context.Context) error {
